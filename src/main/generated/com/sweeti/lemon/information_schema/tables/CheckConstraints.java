...
import com.sweeti.lemon.information_schema.tables.records.CheckConstraintsRecord;
...
public class CheckConstraints extends TableImpl<CheckConstraintsRecord> {
     ...
     */
    public final TableField<CheckConstraintsRecord, String> CONSTRAINT_CATALOG = createField(DSL.name("CONSTRAINT_CATALOG"), SQLDataType.VARCHAR(512).nullable(false), this, "");
     ...
     */
    public final TableField<CheckConstraintsRecord, String> TABLE_NAME = createField(DSL.name("TABLE_NAME"), SQLDataType.VARCHAR(64).nullable(false), this, "");
    ...
    /**
     * The column <code>information_schema.CHECK_CONSTRAINTS.LEVEL</code>.
     */
    public final TableField<CheckConstraintsRecord, String> LEVEL = createField(DSL.name("LEVEL"), SQLDataType.VARCHAR(6).nullable(false), this, "");
