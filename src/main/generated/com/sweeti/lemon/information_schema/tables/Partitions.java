...
import com.sweeti.lemon.information_schema.tables.records.PartitionsRecord;
...
public class Partitions extends TableImpl<PartitionsRecord> {
     ...
     */
    public final TableField<PartitionsRecord, String> TABLE_CATALOG = createField(DSL.name("TABLE_CATALOG"), SQLDataType.VARCHAR(512).nullable(false), this, "");
     ...
     */
    public final TableField<PartitionsRecord, ULong> TABLE_ROWS = createField(DSL.name("TABLE_ROWS"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>information_schema.PARTITIONS.AVG_ROW_LENGTH</code>.
     */
    public final TableField<PartitionsRecord, ULong> AVG_ROW_LENGTH = createField(DSL.name("AVG_ROW_LENGTH"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>information_schema.PARTITIONS.DATA_LENGTH</code>.
     */
    public final TableField<PartitionsRecord, ULong> DATA_LENGTH = createField(DSL.name("DATA_LENGTH"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");
     ...
     */
    public final TableField<PartitionsRecord, ULong> INDEX_LENGTH = createField(DSL.name("INDEX_LENGTH"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>information_schema.PARTITIONS.DATA_FREE</code>.
     */
    public final TableField<PartitionsRecord, ULong> DATA_FREE = createField(DSL.name("DATA_FREE"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");
     ...
     */
    public final TableField<PartitionsRecord, String> PARTITION_COMMENT = createField(DSL.name("PARTITION_COMMENT"), SQLDataType.VARCHAR(80).nullable(false), this, "");

    /**
     * The column <code>information_schema.PARTITIONS.NODEGROUP</code>.
     */
    public final TableField<PartitionsRecord, String> NODEGROUP = createField(DSL.name("NODEGROUP"), SQLDataType.VARCHAR(12).nullable(false), this, "");
