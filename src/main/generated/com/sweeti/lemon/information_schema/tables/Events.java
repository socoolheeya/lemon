...
import com.sweeti.lemon.information_schema.tables.records.EventsRecord;
...
public class Events extends TableImpl<EventsRecord> {
     ...
     */
    public final TableField<EventsRecord, String> DEFINER = createField(DSL.name("DEFINER"), SQLDataType.VARCHAR(384).nullable(false), this, "");
     ...
     */
    public final TableField<EventsRecord, String> EVENT_BODY = createField(DSL.name("EVENT_BODY"), SQLDataType.VARCHAR(8).nullable(false), this, "");
     ...
     */
    public final TableField<EventsRecord, String> EVENT_TYPE = createField(DSL.name("EVENT_TYPE"), SQLDataType.VARCHAR(9).nullable(false), this, "");
     ...
     */
    public final TableField<EventsRecord, String> SQL_MODE = createField(DSL.name("SQL_MODE"), SQLDataType.VARCHAR(8192).nullable(false), this, "");
     ...
     */
    public final TableField<EventsRecord, String> STATUS = createField(DSL.name("STATUS"), SQLDataType.VARCHAR(18).nullable(false), this, "");

    /**
     * The column <code>information_schema.EVENTS.ON_COMPLETION</code>.
     */
    public final TableField<EventsRecord, String> ON_COMPLETION = createField(DSL.name("ON_COMPLETION"), SQLDataType.VARCHAR(12).nullable(false), this, "");
     ...
     */
    public final TableField<EventsRecord, String> EVENT_COMMENT = createField(DSL.name("EVENT_COMMENT"), SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>information_schema.EVENTS.ORIGINATOR</code>.
     */
    public final TableField<EventsRecord, Long> ORIGINATOR = createField(DSL.name("ORIGINATOR"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>information_schema.EVENTS.CHARACTER_SET_CLIENT</code>.
     */
    public final TableField<EventsRecord, String> CHARACTER_SET_CLIENT = createField(DSL.name("CHARACTER_SET_CLIENT"), SQLDataType.VARCHAR(32).nullable(false), this, "");
