...
import com.sweeti.lemon.information_schema.tables.records.InnodbFtIndexTableRecord;
...
public class InnodbFtIndexTable extends TableImpl<InnodbFtIndexTableRecord> {
     ...
     */
    public final TableField<InnodbFtIndexTableRecord, String> WORD = createField(DSL.name("WORD"), SQLDataType.VARCHAR(337).nullable(false), this, "");

    /**
     * The column
     * <code>information_schema.INNODB_FT_INDEX_TABLE.FIRST_DOC_ID</code>.
     */
    public final TableField<InnodbFtIndexTableRecord, ULong> FIRST_DOC_ID = createField(DSL.name("FIRST_DOC_ID"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column
     * <code>information_schema.INNODB_FT_INDEX_TABLE.LAST_DOC_ID</code>.
     */
    public final TableField<InnodbFtIndexTableRecord, ULong> LAST_DOC_ID = createField(DSL.name("LAST_DOC_ID"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column
     * <code>information_schema.INNODB_FT_INDEX_TABLE.DOC_COUNT</code>.
     */
    public final TableField<InnodbFtIndexTableRecord, ULong> DOC_COUNT = createField(DSL.name("DOC_COUNT"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>information_schema.INNODB_FT_INDEX_TABLE.DOC_ID</code>.
     */
    public final TableField<InnodbFtIndexTableRecord, ULong> DOC_ID = createField(DSL.name("DOC_ID"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column
     * <code>information_schema.INNODB_FT_INDEX_TABLE.POSITION</code>.
     */
    public final TableField<InnodbFtIndexTableRecord, ULong> POSITION = createField(DSL.name("POSITION"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");
