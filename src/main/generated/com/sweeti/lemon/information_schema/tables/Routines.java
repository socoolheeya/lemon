...
import com.sweeti.lemon.information_schema.tables.records.RoutinesRecord;
...
public class Routines extends TableImpl<RoutinesRecord> {
     ...
     */
    public final TableField<RoutinesRecord, String> ROUTINE_CATALOG = createField(DSL.name("ROUTINE_CATALOG"), SQLDataType.VARCHAR(512).nullable(false), this, "");
     ...
     */
    public final TableField<RoutinesRecord, String> ROUTINE_TYPE = createField(DSL.name("ROUTINE_TYPE"), SQLDataType.VARCHAR(13).nullable(false), this, "");

    /**
     * The column <code>information_schema.ROUTINES.DATA_TYPE</code>.
     */
    public final TableField<RoutinesRecord, String> DATA_TYPE = createField(DSL.name("DATA_TYPE"), SQLDataType.VARCHAR(64).nullable(false), this, "");
     ...
     */
    public final TableField<RoutinesRecord, String> ROUTINE_BODY = createField(DSL.name("ROUTINE_BODY"), SQLDataType.VARCHAR(8).nullable(false), this, "");
     ...
     */
    public final TableField<RoutinesRecord, String> PARAMETER_STYLE = createField(DSL.name("PARAMETER_STYLE"), SQLDataType.VARCHAR(8).nullable(false), this, "");

    /**
     * The column <code>information_schema.ROUTINES.IS_DETERMINISTIC</code>.
     */
    public final TableField<RoutinesRecord, String> IS_DETERMINISTIC = createField(DSL.name("IS_DETERMINISTIC"), SQLDataType.VARCHAR(3).nullable(false), this, "");

    /**
     * The column <code>information_schema.ROUTINES.SQL_DATA_ACCESS</code>.
     */
    public final TableField<RoutinesRecord, String> SQL_DATA_ACCESS = createField(DSL.name("SQL_DATA_ACCESS"), SQLDataType.VARCHAR(64).nullable(false), this, "");
     ...
     */
    public final TableField<RoutinesRecord, String> SECURITY_TYPE = createField(DSL.name("SECURITY_TYPE"), SQLDataType.VARCHAR(7).nullable(false), this, "");
     ...
     */
    public final TableField<RoutinesRecord, String> SQL_MODE = createField(DSL.name("SQL_MODE"), SQLDataType.VARCHAR(8192).nullable(false), this, "");
     ...
     */
    public final TableField<RoutinesRecord, String> DEFINER = createField(DSL.name("DEFINER"), SQLDataType.VARCHAR(384).nullable(false), this, "");

    /**
     * The column <code>information_schema.ROUTINES.CHARACTER_SET_CLIENT</code>.
     */
    public final TableField<RoutinesRecord, String> CHARACTER_SET_CLIENT = createField(DSL.name("CHARACTER_SET_CLIENT"), SQLDataType.VARCHAR(32).nullable(false), this, "");
