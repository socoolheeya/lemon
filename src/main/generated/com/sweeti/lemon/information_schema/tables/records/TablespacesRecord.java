...
public class TablespacesRecord extends TableRecordImpl<TablespacesRecord> implements Record9<String, String, String, String, ULong, ULong, ULong, ULong, String> {
     ...
     */
    public TablespacesRecord setTablespaceName(String value) {
        set(0, value);
        return this;
    }
     ...
     */
    public TablespacesRecord setEngine(String value) {
        set(1, value);
        return this;
    }
     ...
     */
    public TablespacesRecord setTablespaceType(String value) {
        set(2, value);
        return this;
    }
     ...
     */
    public TablespacesRecord setLogfileGroupName(String value) {
        set(3, value);
        return this;
    }
     ...
     */
    public TablespacesRecord setExtentSize(ULong value) {
        set(4, value);
        return this;
    }
     ...
     */
    public TablespacesRecord setAutoextendSize(ULong value) {
        set(5, value);
        return this;
    }
     ...
     */
    public TablespacesRecord setMaximumSize(ULong value) {
        set(6, value);
        return this;
    }
     ...
     */
    public TablespacesRecord setNodegroupId(ULong value) {
        set(7, value);
        return this;
    }
     ...
     */
    public TablespacesRecord setTablespaceComment(String value) {
        set(8, value);
        return this;
    }
     ...
     * Create a detached, initialised TablespacesRecord
     */
    public TablespacesRecord(com.sweeti.lemon.information_schema.tables.pojos.Tablespaces value) {
        super(Tablespaces.TABLESPACES);

        if (value != null) {
            setTablespaceName(value.getTablespaceName());
            setEngine(value.getEngine());
            setTablespaceType(value.getTablespaceType());
            ...
            setNodegroupId(value.getNodegroupId());
            setTablespaceComment(value.getTablespaceComment());
        }
    }
}
