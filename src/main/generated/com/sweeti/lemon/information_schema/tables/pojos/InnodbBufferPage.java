...
public class InnodbBufferPage implements Serializable {
    ...
    private final InnodbBufferPagePageState pageState;
    private final InnodbBufferPageIoFix ioFix;
    ...
    public InnodbBufferPage(
        ...
        InnodbBufferPagePageState pageState,
        InnodbBufferPageIoFix ioFix,
        Integer isOld,
        ULong freePageClock
    ) {
        this.poolId = poolId;
