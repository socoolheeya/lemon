...
import com.sweeti.lemon.information_schema.tables.records.InnodbMetricsRecord;
...
public class InnodbMetrics extends TableImpl<InnodbMetricsRecord> {
     ...
     */
    public final TableField<InnodbMetricsRecord, String> NAME = createField(DSL.name("NAME"), SQLDataType.VARCHAR(193).nullable(false), this, "");

    /**
     * The column <code>information_schema.INNODB_METRICS.SUBSYSTEM</code>.
     */
    public final TableField<InnodbMetricsRecord, String> SUBSYSTEM = createField(DSL.name("SUBSYSTEM"), SQLDataType.VARCHAR(193).nullable(false), this, "");

    /**
     * The column <code>information_schema.INNODB_METRICS.COUNT</code>.
     */
    public final TableField<InnodbMetricsRecord, Long> COUNT = createField(DSL.name("COUNT"), SQLDataType.BIGINT.nullable(false), this, "");
     ...
     */
    public final TableField<InnodbMetricsRecord, Double> AVG_COUNT = createField(DSL.name("AVG_COUNT"), SQLDataType.FLOAT, this, "");

    /**
     * The column <code>information_schema.INNODB_METRICS.COUNT_RESET</code>.
     */
    public final TableField<InnodbMetricsRecord, Long> COUNT_RESET = createField(DSL.name("COUNT_RESET"), SQLDataType.BIGINT.nullable(false), this, "");
     ...
     */
    public final TableField<InnodbMetricsRecord, Double> AVG_COUNT_RESET = createField(DSL.name("AVG_COUNT_RESET"), SQLDataType.FLOAT, this, "");
    ...
    /**
     * The column <code>information_schema.INNODB_METRICS.ENABLED</code>.
     */
    public final TableField<InnodbMetricsRecord, Integer> ENABLED = createField(DSL.name("ENABLED"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>information_schema.INNODB_METRICS.TYPE</code>.
     */
    public final TableField<InnodbMetricsRecord, InnodbMetricsType> TYPE = createField(DSL.name("TYPE"), SQLDataType.VARCHAR(4).nullable(false).asEnumDataType(com.sweeti.lemon.information_schema.enums.InnodbMetricsType.class), this, "");

    /**
     * The column <code>information_schema.INNODB_METRICS.COMMENT</code>.
     */
    public final TableField<InnodbMetricsRecord, String> COMMENT = createField(DSL.name("COMMENT"), SQLDataType.VARCHAR(193).nullable(false), this, "");
    ...
    @Override
    public Row17<String, String, Long, Long, Long, Double, Long, Long, Long, Double, LocalDateTime, LocalDateTime, Long, LocalDateTime, Integer, InnodbMetricsType, String> fieldsRow() {
     ...
     */
    public <U> SelectField<U> mapping(Function17<? super String, ? super String, ? super Long, ? super Long, ? super Long, ? super Double, ? super Long, ? super Long, ? super Long, ? super Double, ? super LocalDateTime, ? super LocalDateTime, ? super Long, ? super LocalDateTime, ? super Integer, ? super InnodbMetricsType, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function17<? super String, ? super String, ? super Long, ? super Long, ? super Long, ? super Double, ? super Long, ? super Long, ? super Long, ? super Double, ? super LocalDateTime, ? super LocalDateTime, ? super Long, ? super LocalDateTime, ? super Integer, ? super InnodbMetricsType, ? super String, ? extends U> from) {
